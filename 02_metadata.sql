...
BEGIN
    ...
    ELSE
        ...
        ( acquisition_framework_name, acquisition_framework_desc, acquisition_framework_start_date, additional_data
        , meta_create_date)
...
BEGIN
    ...
    ELSE
        ...
        VALUES (_id_framework, '[' || the_shortname ||
                               '] Jeu de données à compléter', the_shortname, 'A compléter', FALSE, TRUE
               , JSONB_BUILD_OBJECT('standard_name', the_shortname), NOW())
