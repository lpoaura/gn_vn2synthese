...
CREATE OR REPLACE VIEW src_lpodatas.v_c_observations
            (id_synthese, uuid, source, desc_source, source_id_data, source_id_sp, taxref_cdnom, cd_nom, cd_ref,
             ...
             pseudo_observer_uid, oiso_code_nidif, statut_repro, oiso_statut_nidif, cs_colo_repro, cs_is_gite,
             cs_periode, nombre_total, code_estimation, date, date_jour, heure, date_an, altitude, mortalite,
             mortalite_cause, type_geom, geom, exp_excl, code_etude, comment, comment_priv, pers_morale, comportement,
