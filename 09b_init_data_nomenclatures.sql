...
INSERT INTO ref_nomenclatures.bib_nomenclatures_types (
    mnemonique, label_default, definition_default, label_fr,
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('VN_ATLAS_CODE'), '0', '0', 'Absence de code', 'Absence de code',
...
(
    ...
    'Preuve physiologique: plaque incubatrice très vascularisée ou œuf présent dans l''oviducte. '
    || 'Observation sur un oiseau en main',
    'Nicheur probable',
    'Preuve physiologique: plaque incubatrice très vascularisée ou œuf présent dans l''oviducte. '
    || 'Observation sur un oiseau en main',
    NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'VisioNature', NULL, NULL, NULL, now(), NULL, TRUE
...
(
    ...
    'Adulte gagnant, occupant ou quittant le site d''un nid comportement révélateur d''un nid occupé '
    || 'dont le contenu ne peut être vérifié (trop haut ou dans une cavité)',
    'Nicheur certain',
    'Adulte gagnant, occupant ou quittant le site d''un nid comportement révélateur d''un nid occupé '
    || 'dont le contenu ne peut être vérifié (trop haut ou dans une cavité)',
    NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'VisioNature', NULL, NULL, NULL, now(), NULL, TRUE
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STATUT_VALID'), 'STATUT_VALID', '1', 'Certain - très probable',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '0', 'Inconnu', 'Inconnu', 'U',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '1', 'Indéterminé', 'Indéterminé',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '2', 'Adulte', 'Adulte', 'MATURE',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '2', 'Adulte', 'Adulte', 'AD',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '2'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '3', 'Juvénile', 'Juvénile', 'YOUNGHAIRY',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '3', 'Juvénile', 'Juvénile',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '3', 'Juvénile', 'Juvénile', 'YOUNGDEP',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '3'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '3', 'Juvénile', 'Juvénile', 'YOUNGBOLD',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '3'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '3', 'Juvénile', 'Juvénile', 'PULL',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '3'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '3', 'Juvénile', 'Juvénile', 'JUVENILE',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '3'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '4', 'Immature', 'Immature', 'IMM',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '4', 'Immature', 'Immature', '5Y',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '4'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '4', 'Immature', 'Immature', '4Y',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '4'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '4', 'Immature', 'Immature', '3Y',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '4'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '4', 'Immature', 'Immature', '2Y',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '4'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '4', 'Immature', 'Immature', '1YP',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '4'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '4', 'Immature', 'Immature', '1Y',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '4'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '5', 'Sub-adulte', 'Sub-adulte', 'SUBAD',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '6', 'Larve', 'Larve', 'LARVA',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '7', 'Chenille', 'Chenille', 'CAT',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '8', 'Têtard', 'Têtard', 'TETARD',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '9', 'Œuf', 'Œuf', 'SPAWN',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '9', 'Œuf', 'Œuf', 'EGG',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '9'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '11', 'Exuvie', 'Exuvie', 'EXUVIE',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '12', 'Chrysalide', 'Chrysalide', 'CHRY',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '15', 'Imago', 'Imago', 'IMAGO',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '25', 'Emergent', 'Emergent', 'EMERGENT',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STADE_VIE'), 'STADE_VIE', '25', 'Emergent', 'Emergent', 'EMERGENCE',
    ref_nomenclatures.get_id_nomenclature('STADE_VIE', '25'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'PHOTO',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'THERMAL',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'NIGHT_VISION',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'TELESCOPE',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'BINOCULARS',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'RESCUE',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'FLY',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'LABO',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'LAIDACTIV',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'OUTSHELTER',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'HAND',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'MAGNIFYING',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'VIDEO',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'VIEW',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'LAID',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'LAIDINACTIV',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'EYE',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'TRAP',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'BONESREMAINS',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'COLLECTED',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '0', 'Vu', 'Vu', 'MUMMIE',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '0'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '1', 'Entendu', 'Entendu', 'AUDIO',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '2', 'Coquilles d''œuf', 'Coquilles d''œuf',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '3', 'Ultrasons', 'Ultrasons', 'DETECT',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '6', 'Fèces/Guano/Epreintes',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '8', 'Nid/Gîte', 'Nid/Gîte', '19',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '8', 'Nid/Gîte', 'Nid/Gîte', '18',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '8'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '8', 'Nid/Gîte', 'Nid/Gîte', '14',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '8'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '10', 'Restes dans pelote de réjection',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '20', 'Autre', 'Autre', 'OLFACTIF',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '20', 'Autre', 'Autre', 'OTHER',
    ref_nomenclatures.get_id_nomenclature('METH_OBS', '20'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '21', 'Inconnu', 'Inconnu', 'U',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_OBS'), 'METH_OBS', '25', 'Vu et entendu', 'Vu et entendu',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('PREUVE_EXIST'), 'PREUVE_EXIST', '1', 'Oui', 'Oui', 'VIDEO',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('PREUVE_EXIST'), 'PREUVE_EXIST', '1', 'Oui', 'Oui', 'PHOTO',
    ref_nomenclatures.get_id_nomenclature('PREUVE_EXIST', '1'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('PREUVE_EXIST'), 'PREUVE_EXIST', '1', 'Oui', 'Oui', 'TRAP',
    ref_nomenclatures.get_id_nomenclature('PREUVE_EXIST', '1'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STATUT_OBS'), 'STATUT_OBS', 'No', 'No', 'Non observé', '100',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('STATUT_OBS'), 'STATUT_OBS', 'No', 'No', 'Non observé', '99',
    ref_nomenclatures.get_id_nomenclature('STATUT_OBS', 'No'), now(), now(), NULL, NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TYP_DENBR'), 'TYP_DENBR', 'Co', 'Co', 'Compté', 'EXACT_VALUE',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TYP_DENBR'), 'TYP_DENBR', 'Es', 'Es', 'Estimé', 'MINIMUM',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TYP_DENBR'), 'TYP_DENBR', 'Es', 'Es', 'Estimé', 'ESTIMATION',
    ref_nomenclatures.get_id_nomenclature('TYP_DENBR', 'Es'), now(), now(), '{
    "visionature_json_path": "{observers,0,estimation_code}"
  }', NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TYP_DENBR'), 'TYP_DENBR', 'NSP', 'NSP', 'Ne sait pas', 'NO_VALUE',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TYP_INF_GEO'), 'TYP_INF_GEO', '1', '1', 'Géoréférencement',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TYP_INF_GEO'), 'TYP_INF_GEO', '2', '2', 'Rattachement', 'transect',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TYP_INF_GEO'), 'TYP_INF_GEO', '2', '2', 'Rattachement', 'subplace',
    ref_nomenclatures.get_id_nomenclature('TYP_INF_GEO', '2'), now(), now(), '{
    "visionature_json_path": "{observers,0,precision}"
  }', NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TYP_INF_GEO'), 'TYP_INF_GEO', '2', '2', 'Rattachement', 'polygone',
    ref_nomenclatures.get_id_nomenclature('TYP_INF_GEO', '2'), now(), now(), '{
    "visionature_json_path": "{observers,0,precision}"
  }', NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TYP_INF_GEO'), 'TYP_INF_GEO', '2', '2', 'Rattachement', 'garden',
    ref_nomenclatures.get_id_nomenclature('TYP_INF_GEO', '2'), now(), now(), '{
    "visionature_json_path": "{observers,0,precision}"
  }', NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TYP_INF_GEO'), 'TYP_INF_GEO', '2', '2', 'Rattachement',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('ETA_BIO'), 'ETA_BIO', '2', 'Observé vivant', 'Observé vivant',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('ETA_BIO'), 'ETA_BIO', '3', 'Trouvé mort', 'Trouvé mort',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('ETA_BIO'), 'ETA_BIO', '3', 'Trouvé mort', 'Trouvé mort', 'PEL',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('ETA_BIO'), 'ETA_BIO', '3', 'Trouvé mort', 'Trouvé mort', 'MUMMIE',
    ref_nomenclatures.get_id_nomenclature('ETA_BIO', '3'), now(), now(), '{
    "visionature_json_path": "{observers,0,details,0,condition}"
  }', NULL
);
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('SEXE'), 'SEXE', '0', 'Inconnu', 'Inconnu', 'U',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('SEXE'), 'SEXE', '1', 'Indéterminé', 'Indéterminé', 'FT',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('SEXE'), 'SEXE', '2', 'Femelle', 'Femelle', 'F',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('SEXE'), 'SEXE', '3', 'Mâle', 'Mâle', 'M',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('SEXE'), 'SEXE', '5', 'Mixte', 'Mixte', 'MF',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('NAT_OBJ_GEO'), 'NAT_OBJ_GEO', 'In', 'Inventoriel', 'Inventoriel',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('NAT_OBJ_GEO'), 'NAT_OBJ_GEO', 'St', 'Stationnel', 'Stationnel',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TECHNIQUE_OBS'), 'TECHNIQUE_OBS', '21',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TECHNIQUE_OBS'), 'TECHNIQUE_OBS', '45',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TECHNIQUE_OBS'), 'TECHNIQUE_OBS', '48',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TECHNIQUE_OBS'), 'TECHNIQUE_OBS', '49',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TECHNIQUE_OBS'), 'TECHNIQUE_OBS', '51',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TECHNIQUE_OBS'), 'TECHNIQUE_OBS', '56', 'Observation d''exuvies',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TECHNIQUE_OBS'), 'TECHNIQUE_OBS', '57',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('TECHNIQUE_OBS'), 'TECHNIQUE_OBS', '67',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '4',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '9', 'Examen auditif direct',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '10',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '11',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '2',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METHO_RECUEIL'), 'METHO_RECUEIL', '1',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METHO_RECUEIL'), 'METHO_RECUEIL', '9',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '18', 'Examen visuel à distance',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '20',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '14',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '17',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '21',
...
VALUES (
    ref_nomenclatures.get_id_nomenclature_type('METH_DETERMIN'), 'METH_DETERMIN', '22',
