...
ALTER FUNCTION src_lpodatas.fct_c_get_taxo_group_values_from_vn (_key TEXT, _sie TEXT, _id INTEGER, OUT _result TEXT) OWNER TO gnadm;
...
ALTER FUNCTION src_lpodatas.fct_c_get_taxref_values_from_vn (_field_name ANYELEMENT, _id_species INTEGER, OUT _result ANYELEMENT) OWNER TO gnadm;
...
ALTER FUNCTION src_lpodatas.fct_c_get_species_values_from_vn (_key ANYELEMENT, _id_species INTEGER, OUT _result ANYELEMENT) OWNER TO gnadm;
...
ALTER FUNCTION src_lpodatas.fct_c_get_observer_full_name_from_vn (_id_universal INTEGER, OUT _result TEXT) OWNER TO gnadm;
...
ALTER FUNCTION src_lpodatas.fct_c_get_entity_from_observer_site_uid (_uid INTEGER, _site TEXT, OUT _result TEXT) OWNER TO gnadm;
...
ALTER FUNCTION src_lpodatas.fct_c_get_behaviours_texts_array_from_id_array (_behaviours JSONB, OUT _result TEXT[]) OWNER TO gnadm;
...
ALTER FUNCTION src_lpodatas.fct_c_get_medias_url_from_visionature_medias_array (_medias JSONB, OUT _result TEXT) OWNER TO gnadm;
...
ALTER FUNCTION src_lpodatas.fct_c_get_observation_uuid (_site CHARACTER VARYING, _id INTEGER, OUT _uuid UUID) OWNER TO gnadm;
